    ...
    return (
        <div className='about' id='about'>
            ...
            <div className="about-text"><p id='about-me'>I am Damiya Gondha, a sophomore pursuing computer science and engineering from IIT Kharagpur. 
                <i>"Computer Science is an ocean I dive deep into!"</i> Yes, that holds true for me. I like to get myself immersed in the complexity of data structures, algorithms and software development. (though it scares me sometimes ;-;)
