    ...
    <div className="project" id="projects">
      <Slider {...settings}>
            <div className="box-1 box">
              <div className="proj-1"><p>Autumn 2023 Physics Sem Website</p></div>
            ...
            <div className="box-2 box">
              <div className="proj-2"><p>GYFE (Open source project maintained by <a href='https://github.com/metakgp' target='_blank'>MetaKGP</a>)</p></div>
